...
(if (> 1 2) 'true_statement 'false_statement)
; expect false_statement

(if (> 1 2) 'true_statement)
; expect okay
...
'(5 (4 seven . (5 . 3)))
; expect (5 (4 seven 5 . 3))

(car '(bus train))
; expect bus

(and 240 4234 3452435)
; expect 3452435

(and #t #f 4234 chicken broth) 
; expect False

(or 365 #t #f clam chowder)
; expect 365

(define h (mu (x) (* x y)))
; expect h

(define b (lambda (x y) (h (+ x x))))
; expect b

(b 98 6)
; expect 1176

(begin (* 24 3) (+ 32 23) (/ 2 10) (* 3 2))
; expect 6

(begin (display 2000) (* 5 4) (/ 10 2))
; expect 20005
