...
public class DList extends List {
   ...
   *  @param edge the edge list following this node.
   **/
  protected DListNode newNode(Object item, DList list,
                              DListNode prev, DListNode next, EList edge) {
    return new DListNode(item, list, prev, next, edge);
  }
  ...
  public void insertFront(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
    DListNode hw = newNode(item, this, head, head.next, new EList());
    head.next.prev = hw;
    head.next = hw;
    size++;
  }
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
    DListNode soHard = newNode(item, this, head.prev, head, new EList());
