...
public class DListNode extends ListNode {
   ...
   */
  DListNode(Object i, DList l, DListNode p, DListNode n, EList e) {
    item = i;
    myList = l;
    prev = p;
    next = n;
  ...
  public EList edgeList() { //return the edgeList of the vertex
    return edgeList;
  }
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DListNode hw = ((DList)myList).newNode(item, (DList)myList, this, (DListNode)this.next(), null);
    this.next.prev = hw;
    this.next = hw;
    myList.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
    DListNode solution = ((DList)myList).newNode(item, (DList)myList, (DListNode)this.prev(), this, null);
