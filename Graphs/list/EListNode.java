...
public class EListNode extends ListNode {
  ...
  public List edgeList() { //EListNode is already is EList, which is contained in DListNode
    return null;
  }
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    EListNode hw = ((EList)myList).newNode(item, (EList)myList, this, (EListNode)this.next());
    this.next.prev = hw;
    this.next = hw;
    myList.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
    EListNode solution = ((EList)myList).newNode(item, (EList)myList, (EListNode)this.prev(), this);
